...
This repository contains raw extracted files and evidence used to build the architecture reference.
If you are new to the repo, read the [`Key Findings Snapshot`](README.md#key-findings-snapshot) first and treat these files as optional deep evidence.
