...
Raw wave-by-wave notes were moved to a dedicated appendix for readability:
- [SESSION_WAVE_NOTES.md](docs/SESSION_WAVE_NOTES.md)

The main architecture narrative continues below with curated findings.
